...
const MinimalistPortfolio = () => {
  ...
  return (
    <div className={`min-h-screen font-serif transition-colors duration-300 ${isDarkMode ? 'dark bg-charcoal text-alabaster' : 'bg-alabaster text-charcoal'}`}>
      <div className="max-w-4xl mx-auto px-4 py-8">
        <header className="mb-16 flex justify-between items-center">
          <div className="flex items-center">
            <h1 className="font-serif text-4xl tracking-tight">Rakshita Murugan</h1>
            <img src="/images/icon.png" alt="Icon" className="w-8 h-8 ml-4" />
          </div>
